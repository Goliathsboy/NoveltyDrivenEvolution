...
public class ControllerNoveltyScore implements CalculateScore {
    private String parameters;

    public ControllerNoveltyScore(String parameters) {
    ...
    public double calculateScore(final MLMethod method) {
        ...
        //int seed = jsonParameters.getInt("seed");
        Random r = new Random();
        ...
        double score = PopulationInformation.calculateNovelty(averageNoveltyData);
